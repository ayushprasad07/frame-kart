...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-6 md:px-12 lg:px-16 xl:px-20">
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {orders.map(order => (
              ...
              >
                <div className="flex justify-between items-start flex-wrap gap-6 border-b border-gray-200 pb-4">
                  <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <select
                      ...
                      aria-label={`Change order ${order._id.slice(-6)} status`}
                    >
                      <option value="pending">Pending</option>
                      <option value="completed">Completed</option>
                      <option value="cancelled">Cancelled</option>
